    ...
    <div class="row w-100 shadow-lg rounded-4 overflow-hidden bg-white login-container">
        ...
        <div class="col-lg-6 d-none d-lg-flex flex-column justify-content-center p-5 text-white"
            ...
            <ul class="list-unstyled mt-4 fs-5">
                <li class="mb-3"><i class="bi bi-credit-card me-2"></i> Digital Banking</li>
                <li class="mb-3"><i class="bi bi-clock-history me-2"></i> 24/7 Access</li>
                <li><i class="bi bi-send me-2"></i> Instant Transfers</li>
            </ul>
        </div>
        ...
        <div class="col-lg-6 p-5">
            ...
            <form method="post" action="${pageContext.request.contextPath}/login">
                ...
                <!-- Remember Me (optional, ignored for now) -->
